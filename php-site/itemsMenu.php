...
<div id="main">
	...
	<div class="head">
		<div class="col-div-6">
<span style="font-size:30px;cursor:pointer; color: white;" class="nav"  >&#9776; Items Menu</span>
...
$sql = "SELECT ID, Name, Price, Stock FROM itemTable";
...
?> 								
	...
	<div class="col-div-4">
      ...
      <input type="text" name="ID" class="input" placeholder="Existing Product ID">
	  <input type="text" name="Name" class="input" placeholder="New Product Name">
      <input type="text" name ="Price" class="input" placeholder="New Price">
      <input type="text" name ="Stock" class="input" placeholder="New Stock">
      <input type="text"  name ="Desc" class="input" placeholder="Desc">
    </div>	  
       <input type="submit" name="edit" class="button" value="Update Product">	
			</form>
	</div>
		</div>
	</div>
	...
	<div class="col-div-4">
      ...
      <input type="text" name ="Stock" class="input" placeholder="Stock">
      <input type="text"  name ="Desc" class="input" placeholder="Desc">
    </div>	  
